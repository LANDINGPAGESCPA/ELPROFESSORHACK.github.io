...
function loginExoResign() {
  ...
  app.request.post('loginExoResign.php', { di21:a9812j, si34:asdi3d29 }, function (data) {
    ...
    buttons: [
      ...
      },
      {
        ...
        onClick: function () {
          ...
          app.request.post('modifyApp.php', { dsk34:owner, k2345:ipa, jke23: "accepted" }, function (data) {
            app.dialog.alert(data);
            console.log('Load was performed');
          });
        }
      },
      {
        ...
        onClick: function () {
          ...
          app.request.post('modifyApp.php', { dsk34:owner, k2345:ipa, jke23: "rejected" }, function (data) {
            app.dialog.alert(data);
            console.log('Load was performed');
          });
        }
